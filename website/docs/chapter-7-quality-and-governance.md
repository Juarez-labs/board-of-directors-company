...
sidebar_position: 7
description: "How to design QC gates, apply the QCAgent scoring rubric, use the approval workflow, and maintain the audit trail."
tags: [intermediate, quality, governance, review, qc-gate, audit]
---

:::info Chapter Metadata
- **Difficulty:** Intermediate
- **Target Audience:** Teams with active agents completing directives
- **Prerequisites:** [Chapter 6: Heartbeat System and Task Management](./chapter-6-heartbeats)
:::
...
**Heartbeat summaries** (described in [Chapter 6](./chapter-6-heartbeats)) capture the agent's understanding of what it did and why in each run. They are retained permanently and can be read like a log of agent reasoning.
...
*Next: [Chapter 8 — Advanced Patterns and Anti-Patterns](./chapter-8-patterns)*
