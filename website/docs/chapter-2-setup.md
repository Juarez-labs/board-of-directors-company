...
sidebar_position: 2
description: "Step-by-step guide to creating a Paperclip account, installing the CLI, configuring your first agent, and running a test heartbeat."
tags: [beginner, setup, cli, configuration, agent]
---

:::info Chapter Metadata
- **Difficulty:** Beginner–Intermediate
- **Target Audience:** Assumes comfort with a terminal and JSON config files
- **Prerequisites:** [Chapter 1: Introduction to AI Agent Companies](./chapter-1-introduction)
:::
...
This is the foundation every subsequent chapter builds on. In [Chapter 3](./chapter-3-roles-and-hiring), we'll expand the team — adding the role archetypes that turn a single-agent setup into a functioning multi-agent company.

---

**Previous:** [Chapter 1: Introduction to AI Agent Companies](./chapter-1-introduction)
**Next:** [Chapter 3: Agent Roles and Hiring](./chapter-3-roles-and-hiring)
