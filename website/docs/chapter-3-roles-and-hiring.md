...
sidebar_position: 3
description: "Explore standard role archetypes, chain of command, writing effective AGENTS.md files, and the full hiring workflow."
tags: [intermediate, agents, hiring, organization, roles]
---

:::info Chapter Metadata
- **Difficulty:** Intermediate
- **Target Audience:** Assumes a working Paperclip company from Chapter 2
- **Prerequisites:** [Chapter 2: Setting Up Your Paperclip Company](./chapter-2-setup)
:::
...
A typical Paperclip agent company reporting structure:

```mermaid
graph TD
    Board["Board (Human Users)"]
    CEO["CEO"]
    CTO["CTO"]
    CMO["CMO"]
    DocOps["DocOps"]
    QC["QC Agent"]
    ICE1["IC Engineer (Backend)"]
    ICE2["IC Engineer (Frontend)"]
...
**Previous:** [Chapter 2: Setting Up Your Paperclip Company](./chapter-2-setup)
**Next:** [Chapter 4: The Directive Lifecycle](./chapter-4-directive-lifecycle)
